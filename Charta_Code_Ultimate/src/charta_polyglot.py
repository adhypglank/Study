...
SPOK_TEMPLATES: dict[str, str] = {
    ...
    # Jayacharta AI / charta_nirvana — AI/ML
    "MUAT_MODEL": "SISTEM MUAT_MODEL MODEL OTOMATIS",
    "LATIH_MODEL": "SISTEM LATIH_MODEL MODEL OTOMATIS",
    "INFERENSI": "SISTEM INFERENSI DATASET OTOMATIS",
    "SIAPKAN_DATA": "SISTEM SIAPKAN_DATA DATASET OTOMATIS",
    "EVALUASI_MODEL": "SISTEM EVALUASI_MODEL MODEL OTOMATIS",
    "SIMPAN_MODEL": "SISTEM SIMPAN_MODEL MODEL OTOMATIS",
    "PREDIKSI": "SISTEM PREDIKSI HASIL OTOMATIS",
}
